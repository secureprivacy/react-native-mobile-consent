...
export { SecurePrivacyMobileConsent } from './SecurePrivacyMobileConsent';
...
export type { Subscription } from './SecurePrivacyMobileConsent';
export { SPLogType } from './enums/SPLogType';
